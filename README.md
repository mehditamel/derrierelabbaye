...
> Self-description: *« Apéro marseillais — bar à tapas & cocktails, juste derrière
> l'Abbaye. »*
...
- **GitHub:** [`mehditamel/derrierelabbaye`](https://github.com/mehditamel/derrierelabbaye)
  — *currently a placeholder repo* (`"Site internet du bar DERRIERE L'ABBAYE"`),
  no code yet. Explore it for future site source; this system can seed that build.
...
where it's already common bar vocabulary (*Long Drinks, Shooters, London Mule*).
...
- *« À partager — froid / chaud »* (menu section framing)
- *« À accompagner d'un verre, d'une bouteille… ou des deux. »*
- *« Apéro marseillais »* · *« Bar à tapas & cocktails »*
- Legal footer (required, FR): *« L'abus d'alcool est dangereux pour la santé,
  à consommer avec modération. »*

**What to avoid:** start-up speak, exclamation spam, hashtags in body copy, anglicisms
where a French word exists, hard-sell CTAs ("BUY NOW"). Prefer *« Réserver une table »*,
...
- Pairing rule: **two grounds only** — ivoire paper *or* noir. Gold is the bridge.
...
**Backgrounds.** Flat ivory paper, *very* subtly warm — **no gradients** on paper
...
elevation is *light*, not shadow: the amber glow (`--shadow-glow`) behind a CTA or
...
- **Emoji: never.**
- ⚑ *Substitution flagged:* Lucide is a stand-in. If a bespoke line-icon set is
