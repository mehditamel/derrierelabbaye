...
import { AbbayePhoto } from "@/components/site/AbbayePhoto";
  ...
  return (
    <section className={styles.page}>
      ...
      <div className="u-container">
        ...
        <AbbayePhoto photo="nuit" featured />

        <div className={styles.content}>
          <p className={styles.lede}>
            Un des plus vieux coins de Marseille : l&apos;Abbaye Saint-Victor veille sur la rive sud
            du Vieux-Port depuis plus de quinze siècles. Tout autour, des ruelles tranquilles, la
            mer en contrebas, la lumière du soir sur la pierre. Et, dans l&apos;une de ces rues
            ...
            <div className={styles.block}>
              ...
              <div className={styles.prose}>
                <p>
                  ...
                  médiévale subsiste une <strong>église fortifiée</strong> aux allures de
                  forteresse, ses hautes tours crénelées et ses <strong>cryptes</strong> — un dédale
                  de pierre où l&apos;on descend dans le silence des siècles, sous le niveau de la
                  rue.
                </p>
                <p>
          ...
          <Reveal delay={120}>
            <div className={styles.block}>
              ...
              <div className={styles.prose}>
                <p>
                  Le quartier est un balcon sur la ville. En contrebas, le{" "}
                  <strong>Vieux-Port</strong> et ses pointus, à une dizaine de minutes à pied par
                  les quais. À deux pas, le <strong>jardin du Pharo</strong> et son panorama sur la
                  passe et le large. Plus haut, la <strong>Bonne Mère</strong> —
                  Notre-Dame-de-la-Garde — veille sur Marseille ; au loin, le <strong>MuCEM</strong>{" "}
                  et le Fort Saint-Jean ferment l&apos;entrée du port.
                </p>
                <p>
                  C&apos;est un Marseille à hauteur d&apos;homme : on visite l&apos;abbaye, on
                  grimpe vers la basilique, on traîne sur les quais au coucher du soleil. Et quand
                  vient l&apos;heure de l&apos;apéro, on redescend vers la rue calme, juste derrière
                  le monument.
                </p>
              </div>
            </div>
          ...
          <Reveal delay={120} variant="scale">
            <div className={styles.venue}>
              ...
              <p className={styles.venueText}>
                Une devanture en acier corten, une lumière chaude, des bouteilles qui scintillent
                dans la pénombre : c&apos;est l&apos;apéro marseillais dans une rue tranquille de
                Saint-Victor. Tapas à partager, planches de caractère et cocktails qui sentent le
                sud — l&apos;adresse idéale pour prolonger la visite, à l&apos;abri de la foule du
                Vieux-Port.
              </p>
